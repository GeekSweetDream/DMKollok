...
void showLibrary();                         // Функция для вывода справки на экран
...
/*
 ...
 Функция для вывода справки на экран пользователя

 */

void showLibrary()
    {
        printf("\n          Программа для работы с длинными числами!\nЭта программа предоставляет работу с длинными числами разных \nтипов: натуральные, "
                       "целые, рациональные, многочлены!\n\nПравила пользования программой:\n 1) Выбираете тип чисел, с которым вы хотите работать\n 2) "
                       "Вы должны ввести два числа \n 3) Вы можете неоднократно выбирать разные модуля, не меняя значения своих чисел\n 4) Вы можете также "
                       "ввести новые два числа\n\nПравила ввода чисел:\n 1) Числа вводятся строкой, окончаением ввода считается "
                       "нажатие клавиши enter\n 2) Все символы, помимо цифр, будут опущены из строки! \n\n Пример: \n 1) Ввод: 1234 \n    Вывод: 1234"
                       "\n 2) Ввод: 123as2cc3\n    Вывод: 12323\n");
    }
